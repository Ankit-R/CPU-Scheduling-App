...
public class SJF extends Activity {

	Button btn_main;
	EditText et_main;
	int n;
	String str;
	String title = "SJF SCHEDULING";
							...
							final_table.setOnClickListener(new OnClickListener() {
								...
								public void onClick(View arg0) {
									...
									clear_whole.setOnClickListener(new OnClickListener() {
										...
										@Override
										public void onClick(View arg0) {
											Intent i = new Intent(SJF.this, SJF.class);
						                    startActivity(i);
						                    finish();
									...
									back.setOnClickListener(new OnClickListener() {
										...
										@Override
										public void onClick(View arg0) {
											Intent i = new Intent(SJF.this, FIRST.class);
						                    startActivity(i);
						                    finish();
